...
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| 《Fundamentals of Computer Graphics, 4th Edition》<br>([UoA lib](https://learning.oreilly.com/library/view/fundamentals-of-computer/9781439865521/)) | 《计算机图形学基础》<br>概述了计算机图形学相关基础，可以用来了解图形学的大全景。 |
